...
pub fn can_task_be_cancelled_while_active(task: &TaskKind) -> bool {
    match task {
        TaskKind::AwaitingSignal { .. } => AwaitingSignal::can_task_be_cancelled_while_active(),
        TaskKind::Construct { .. } => Construct::can_task_be_cancelled_while_active(),
        TaskKind::RequestAccess { .. } => RequestAccess::can_task_be_cancelled_while_active(),
        TaskKind::DockAtEntity { .. } => DockAtEntity::can_task_be_cancelled_while_active(),
        TaskKind::Undock { .. } => Undock::can_task_be_cancelled_while_active(),
        TaskKind::ExchangeWares { .. } => ExchangeWares::can_task_be_cancelled_while_active(),
        TaskKind::MoveToEntity { .. } => MoveToEntity::can_task_be_cancelled_while_active(),
        TaskKind::MoveToPosition { .. } => MoveToPosition::can_task_be_cancelled_while_active(),
        TaskKind::MoveToSector { .. } => MoveToSector::can_task_be_cancelled_while_active(),
        TaskKind::UseGate { .. } => UseGate::can_task_be_cancelled_while_active(),
        TaskKind::MineAsteroid { .. } => MineAsteroid::can_task_be_cancelled_while_active(),
        TaskKind::HarvestGas { .. } => HarvestGas::can_task_be_cancelled_while_active(),
    }
}
