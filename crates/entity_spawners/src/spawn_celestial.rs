...
use common::types::entity_id_map::CelestialIdMap;
use common::types::entity_wrappers::{CelestialEntity, SectorEntity};
use common::types::polar_coordinates::PolarCoordinates;
use common::types::sprite_handles::SpriteHandles;
use persistence::data::{CelestialKindSaveData, IndividualSectorCelestialSaveData};
...
pub fn spawn_celestial(
    ...
    celestial_data: &IndividualSectorCelestialSaveData,
    sector_pos: Vec2,
